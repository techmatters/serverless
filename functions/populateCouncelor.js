...
var fetchData = function (workspaceSID) { return __awaiter(void 0, void 0, void 0, function () {
    var data, dataJson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, node_fetch_1.default("https://taskrouter.twilio.com/v1/Workspaces/" + workspaceSID + "/Workers", {
                    method: 'GET',
                    headers: {
...
exports.handler = function (context, event, callback) { return __awaiter(void 0, void 0, void 0, function () {
    var body, workspaceSID, dataJson, workers, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                body = event;
                workspaceSID = body.workspaceSID || process.env.TORONTO_LINE_WORKSPACE;
                if (workspaceSID === undefined) {
                    callback('Error: Workspace parameter not provided');
                    return [2 /*return*/];
                }
                return [4 /*yield*/, fetchData(workspaceSID)];
            case 1:
                dataJson = _a.sent();
                ...
                workers = dataJson.workers.map(function (w) { return ({
                    sid: w.sid,
